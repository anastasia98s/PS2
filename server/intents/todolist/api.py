...
def add_todo(aktivitaet, datezeit, benutzer_id):
    try:
        response = requests.post(f"http://{KONTOVERWALTUNG_SERVICE_IP}:{KONTOVERWALTUNG_SERVICE_PORT}/kontoverwaltung/add_todo", json={"aktivitaet":aktivitaet, "datezeit":datezeit, "benutzer_id":benutzer_id})
...
def show_todo(aktivitaet, datum, datezeit, benutzer_id):
    try:
        response = requests.post(f"http://{KONTOVERWALTUNG_SERVICE_IP}:{KONTOVERWALTUNG_SERVICE_PORT}/kontoverwaltung/show_todo", json={"aktivitaet":aktivitaet, "datum":datum, "datezeit":datezeit, "benutzer_id":benutzer_id})
...
def delete_todo(aktivitaet, datum, datezeit, benutzer_id):
    try:
        response = requests.post(f"http://{KONTOVERWALTUNG_SERVICE_IP}:{KONTOVERWALTUNG_SERVICE_PORT}/kontoverwaltung/delete_todo", json={"aktivitaet":aktivitaet, "datum":datum, "datezeit":datezeit, "benutzer_id":benutzer_id})
