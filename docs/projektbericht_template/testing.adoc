...
image::{dir_assets}/szenario_cm.png[Szenario, width=55%, align=center, title="Szenario"]
image::{dir_assets}/absicht_szenario_cm.png[Absicht & Szenario, width=80%, align=center, title="Absicht & Szenario"]
image::{dir_assets}/absicht_cm.png[Anmerkung, width=60%, align=center, title="Anmerkung"]
