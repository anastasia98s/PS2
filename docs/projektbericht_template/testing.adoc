...
image::{dir_assets}/absicht_cm.png[Absicht, width=50%, align=center, title="Absicht"]
image::{dir_assets}/szenario_cm.png[Szenario, width=50%, align=center, title="Szenario"]
image::{dir_assets}/absicht_szenario_cm.png[Absicht & Szenario, width=90%, align=center, title="Absicht & Szenario"]
image::{dir_assets}/absicht_cm.png[Anmerkung, width=50%, align=center, title="Anmerkung"]
...
image::{dir_assets}/aktivierung_cm.png[Aktivierungswort, width=60%, align=center, title="Aktivierungswort"]
