...
image::{dir_assets}/notenverteilung.png[Notenverteilung, width=50%, align=center, title="Notenverteilung"]
...
image::{dir_assets}/absicht_cm.png[Absicht, align=center, title="Absicht"]
image::{dir_assets}/szenario_cm.png[Szenario, align=center, title="Szenario"]
image::{dir_assets}/absicht_szenario_cm.png[Absicht & Szenario, align=center, title="Absicht & Szenario"]
image::{dir_assets}/absicht_cm.png[Anmerkung, align=center, title="Anmerkung"]
...
image::{dir_assets}/aktivierung_cm.png[Aktivierungswort, align=center, title="Aktivierungswort"]
