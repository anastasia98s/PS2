...
image::{dir_assets}/aktivierung_sum.png[Zusammenfassung des Aktivierungswortmodells, width=90%, align=center, title="Zusammenfassung des Aktivierungswortmodells"]
