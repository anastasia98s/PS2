...
image::{dir_assets}/authentifizierung_sum.png[Zusammenfassung des Authentifizierungsmodells, width=80%, align=center, title="Zusammenfassung des Authentifizierungsmodells"]
...
image::{dir_assets}/aktivierung_sum.png[Zusammenfassung des Aktivierungswortmodells, width=80%, align=center, title="Zusammenfassung des Aktivierungswortmodells"]
