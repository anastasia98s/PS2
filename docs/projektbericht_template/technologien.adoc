...
image::{dir_assets}/authentifizierung_sum.png[Zusammenfassung des Authentifizierungsmodells, width=100%, align=center, title="Zusammenfassung des Authentifizierungsmodells"]
...
image::{dir_assets}/textklassifizierung_sum.png[Zusammenfassung des Textklassifizierungsmodells, width=80%, align=center, title="Zusammenfassung des Textklassifizierungsmodells"]
...
image::{dir_assets}/aktivierung_sum.png[Zusammenfassung des Aktivierungswortmodells, width=100%, align=center, title="Zusammenfassung des Aktivierungswortmodells"]
